            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="title">
                            <h4>Tambah Data Soal Pre-Test (<?= $kursus->nama_kursus ?>)</h4>
                        </div>
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?=base_url('admin/dashboard')?>">Home</a></li>
                                <li class="breadcrumb-item" aria-current="page"><a href="<?=base_url('admin/posttest/soal_posttest/' . $kursus->id_kursus)?>">Post-Test</a></li>
            ...
            <div class="panel-body">
				<div class="pd-20 card-box mb-30">
					...
					<?php
                        ...
                        echo form_open_multipart('admin/posttest/add/' . $kursus->id_kursus);
                        ?>
