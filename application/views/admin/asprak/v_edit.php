				...
				<div class="pd-20 card-box mb-30">
					...
					<?php
                        ...
                        <div class="form-group">
							...
							<input class="form-control" name="no_hp" value="<?= $asprak->no_hp ?>" type="text" placeholder="Nomor Handphone Atau WhatsApp">
						</div>

                        <div class="form-group">
							<label>Foto Saat ini</label><br>
							<img src="<?= base_url('upload/foto_asprak/'. $asprak->foto_asprak)?>" width="150px" alt="">
						</div>

                        <div class="form-group">
							<label>Upload Foto Asprak  <i style="color: red;">*Optional</i></label>
