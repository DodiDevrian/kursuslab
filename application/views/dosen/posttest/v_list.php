    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('dosen/kursus') ?>">Kursus</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Soal Post Test</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="card-box mb-30 pd-20">
                ...
                <?php if ($count < 30) { ?>
                    <p class="mt-3" style="color: red;">Soal Belum Dibuat</p>
                <?php } else { ?>
